...
class IllegalCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(
            pos_start, pos_end, "This char can't be used in here...", details
        )
...
class ExpectedCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(
            pos_start, pos_end, "Expected ", details
        )
...
class InvalidSyntaxError(Error):
    def __init__(self, pos_start, pos_end, details=""):
        super().__init__(
            pos_start, pos_end, "Syntax Error.../n Where did you studied Coding? ", details
        )
...
class RTError(Error):
    def __init__(self, pos_start, pos_end, details, context):
        super().__init__(
            pos_start, pos_end, "SystoCode Runtime Error", details
        )
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expected 'RETURN', 'CONTINUE', 'BREAK', 'pwease', 'IF', 'FOR', 'WHILE', 'FUNCTION', int, float, identifier, '+', '-', '(', '[' or 'NOT'",
                )
            )
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expected 'pwease', 'IF', 'FOR', 'WHILE', 'FUNCTION', int, float, identifier, '+', '-', '(', '[' or 'NOT'",
                )
            )
        ...
        if isinstance(other, Number):
            ...
            try:
                ...
                return None, RTError(
                    other.pos_start,
                    other.pos_end,
                    "Element at this index could not be recieved from list because index is out of bound",
                    self.context,
                )
        else:
            return None, Value.illegal_operation(self, other)
        ...
        if isinstance(other, Number):
            try:
                ...
                return None, RTError(
                    other.pos_start,
                    other.pos_end,
                    "Element at this index could not be received from list because index is out of bounds",
                    self.context,
                )
        else:
            return None, Value.illegal_operation(self, other)
...
global_symbol_table.set("is_abc", BuiltInFunction.is_string)
